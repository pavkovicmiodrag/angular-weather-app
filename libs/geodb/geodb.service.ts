...
export class GeoDbService {
  ...
  findAdminDivisions(
    request: FindAdminDivisionsRequest
  ): Observable<GeoResponse<PlaceSummary[]>> {
    ...
    if (request.excludedCountryIds) {
      params = params.set(
        'excludedCountryIds',
        request.excludedCountryIds.join(',')
      );
    }
  ...
  findPlace(
    request: GetPlaceDetailsRequest
  ): Observable<GeoResponse<PlaceDetails>> {
    ...
    return this.httpClient.get<GeoResponse<PlaceDetails>>(endpoint, {
      params: params,
    });
  }
  ...
  findPlacesNearLocation(
    request: FindPlacesNearLocationRequest
  ): Observable<GeoResponse<PlaceSummary[]>> {
    let params: HttpParams = GeoDbService.buildPagingParams(request);
    ...
    const locationId = GeoDbService.toLocationString(request.location).replace(
      /\+/g,
      '%2B'
    );
    ...
    return this.httpClient.get<GeoResponse<PlaceSummary[]>>(endpoint, {
      params: params,
    });
  }

  findPlacesNearPlace(
    request: FindPlacesNearPlaceRequest
  ): Observable<GeoResponse<PlaceSummary[]>> {
    let params: HttpParams = GeoDbService.buildPagingParams(request);
    ...
    const endpoint =
      this.placesEndpoint + '/' + request.placeId + '/nearbyCities';
  ...
  ): Observable<GeoResponse<CountrySummary[]>> {
    let params: HttpParams = GeoDbService.buildPagingParams(request);
  ...
  findCountry(
    request: GetCountryDetailsRequest
  ): Observable<GeoResponse<CountryDetails>> {
  ...
  ): Observable<GeoResponse<Currency[]>> {
    let params: HttpParams = GeoDbService.buildPagingParams(request);
  ...
  findLanguages(
    request: FindCollectionRequest
  ): Observable<GeoResponse<Language[]>> {
  ...
  findLocales(
    request: FindCollectionRequest
  ): Observable<GeoResponse<Locale[]>> {
    const params: HttpParams = GeoDbService.buildPagingParams(request);

    return this.httpClient.get<GeoResponse<Locale[]>>(this.localesEndpoint, {
      params: params,
    });
  }

  findRegion(
    request: GetRegionDetailsRequest
  ): Observable<GeoResponse<RegionDetails>> {
    const endpoint =
      this.buildRegionsEndpoint(request.countryId) + '/' + request.regionCode;
  ...
  findRegionPlaces(
    request: FindRegionCitiesRequest
  ): Observable<GeoResponse<PlaceSummary[]>> {
    const endpoint =
      this.buildRegionEndpoint(request.countryId, request.regionCode) +
      '/cities';
  ...
  findRegions(
    request: FindRegionsRequest
  ): Observable<GeoResponse<RegionSummary[]>> {
    ...
    return this.httpClient.get<GeoResponse<RegionSummary[]>>(endpoint, {
      params: params,
    });
  }
  ...
  findTimeZones(
    request: FindCollectionRequest
  ): Observable<GeoResponse<TimeZone[]>> {
    const params: HttpParams = GeoDbService.buildPagingParams(request);
  ...
  getPlaceDistance(
    request: GetPlaceDistanceRequest
  ): Observable<GeoResponse<number>> {
    ...
    return this.httpClient.get<GeoResponse<number>>(endpoint, {
      params: params,
    });
  }
  ...
  private buildPlaceEndpoint(placeId: string): string {
    return this.placesEndpoint + '/' + placeId;
  }
